...
public class Presentation extends JFrame {
	...
	/**
	 * Zeig den Programminformationsdialog an
	 */
	private void showAbouts(){
		DialogAboutBox about = new DialogAboutBox(this);
		if(about.ok()){
			// nvm
		}
	}
	...
	public class HalmaMenuBar extends JMenuBar {
		...
		public HalmaMenuBar() {
			...
			addItem(
					"<html>Darstellung vergr&ouml;&szlig;ern</html>",
					"groesser",
					KeyEvent.VK_PLUS,
			...
			menu.addSeparator();
			// Menuepunkt Ueber
			addItem("<html>&Uuml;ber BTU SWP Halma</html>", "ueber", -1,
		...
		private void addItem(String label, String cmd, int code, String toolTip) {
			...
			if (code != -1) {
				mi.setAccelerator(KeyStroke.getKeyStroke(code,
